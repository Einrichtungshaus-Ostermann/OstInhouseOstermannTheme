...
namespace OstInhouseOstermannTheme;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstInhouseOstermannTheme extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_inhouse_ostermann_theme.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_inhouse_ostermann_theme.view_dir', $this->getPath() . '/Resources/views/');
